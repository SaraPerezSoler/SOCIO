...
public class ModelInfoPackageImpl extends EPackageImpl implements ModelInfoPackage {
	 ...
	 * @generated
	 */
	private EClass nlIdentifierEClass = null;
	 ...
	 * @generated
	 */
	private EClass defaultIdEClass = null;
	 ...
	 * @generated
	 */
	public EAttribute getNLElement_CreateTemplates() {
		return (EAttribute)nlElementEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getNLElement_DeleteTemplates() {
		return (EAttribute)nlElementEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getNLClass_WithContainer() {
	...
	public EReference getNLClass_Id() {
		return (EReference)nlClassEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EClass getNLIdentifier() {
		return nlIdentifierEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getDefaultId() {
		return defaultIdEClass;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(nlElementEClass, NL_ELEMENT__CREATE_TEMPLATES);
		createEAttribute(nlElementEClass, NL_ELEMENT__DELETE_TEMPLATES);

		nlClassEClass = createEClass(NL_CLASS);
		createEReference(nlClassEClass, NL_CLASS__CLASS);
		createEAttribute(nlClassEClass, NL_CLASS__WITH_CONTAINER);
		...
		nlIdentifierEClass = createEClass(NL_IDENTIFIER);

		defaultIdEClass = createEClass(DEFAULT_ID);
	...
	public void initializePackageContents() {
		...
		defaultIdEClass.getESuperTypes().add(this.getNLIdentifier());
		nlAttributeEClass.getESuperTypes().add(this.getNLFeature());
		nlAttributeEClass.getESuperTypes().add(this.getNLIdentifier());
		...
		initEAttribute(getNLElement_CreateTemplates(), theEcorePackage.getEString(), "createTemplates", null, 0, -1, NLElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNLElement_DeleteTemplates(), theEcorePackage.getEString(), "deleteTemplates", null, 0, -1, NLElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNLClass_WithContainer(), ecorePackage.getEBoolean(), "withContainer", null, 1, 1, NLClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNLClass_Create(), ecorePackage.getEBooleanObject(), "create", "false", 1, 1, NLClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNLClass_Id(), this.getNLIdentifier(), null, "id", null, 1, -1, NLClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(nlIdentifierEClass, NLIdentifier.class, "NLIdentifier", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(defaultIdEClass, DefaultId.class, "DefaultId", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEAttribute(getWebService_Protocol(), ecorePackage.getEString(), "protocol", "HTTP", 1, 1, WebService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebService_Method(), ecorePackage.getEString(), "method", null, 1, 1, WebService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebService_Domain(), ecorePackage.getEString(), "domain", null, 1, 1, WebService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebService_Port(), ecorePackage.getEInt(), "port", null, 1, 1, WebService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebService_Path(), ecorePackage.getEString(), "path", null, 0, -1, WebService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
