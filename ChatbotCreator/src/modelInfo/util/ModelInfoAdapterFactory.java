...
public class ModelInfoAdapterFactory extends AdapterFactoryImpl {
	...
	protected ModelInfoSwitch<Adapter> modelSwitch =
		new ModelInfoSwitch<Adapter>() {
			...
			@Override
			public Adapter caseNLIdentifier(NLIdentifier object) {
				return createNLIdentifierAdapter();
			}
			@Override
			public Adapter caseDefaultId(DefaultId object) {
				return createDefaultIdAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link modelInfo.NLIdentifier <em>NL Identifier</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createNLIdentifierAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link modelInfo.DefaultId <em>Default Id</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDefaultIdAdapter() {
		return null;
	}
