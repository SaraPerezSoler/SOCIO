...
public class ModelInfoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelInfoPackage.NL_IDENTIFIER: {
				NLIdentifier nlIdentifier = (NLIdentifier)theEObject;
				T result = caseNLIdentifier(nlIdentifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelInfoPackage.DEFAULT_ID: {
				DefaultId defaultId = (DefaultId)theEObject;
				T result = caseDefaultId(defaultId);
				if (result == null) result = caseNLIdentifier(defaultId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelInfoPackage.NL_ATTRIBUTE: {
				...
				if (result == null) result = caseNLIdentifier(nlAttribute);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>NL Identifier</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>NL Identifier</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNLIdentifier(NLIdentifier object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Default Id</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Default Id</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDefaultId(DefaultId object) {
		return null;
	}
