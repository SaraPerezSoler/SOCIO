...
public interface CommandList {
	...
	* */
	...
	/**@author Sara Pérez-Soler
	* Add a voting in a consensus decision.
	* Needs: a project (channel/usernick/projectName or projectId), <consensusName>#<Option1>:<Pos>-<Option2>:<pos>-...
	*/
	...
	*/
	...
	public static final String END_CONSENSUS="END_CONSENSUS";
	...
	*/
	...
	/**@author Sara Pérez-Soler
	* send back a pic with the project actions
	* Needs: a project (channel/usernick/projectName or projectId)
	*/

	public static final String HISTORY_PROJECT="HISTORY_PROJECT";
	...
	*/
	...
	/**@author Sara Pérez-Soler
	* start the necesary process to discurs about the branchs
	* Needs: a project (channel/usernick/projectName or projectId),group branch name about debate (text field), users to debate(userstosearch field <user1>-<user2>-...)
	*/

	public static final String START_C_VOTING="START_C_VOTING";

	/**@author Sara Pérez-Soler
	* start the necesary process to discurs about the branchs
	* Needs: a project (channel/usernick/projectName or projectId), branchs about debate (text field), users to debate(userstosearch field <user1>-<user2>-...)
	*/
