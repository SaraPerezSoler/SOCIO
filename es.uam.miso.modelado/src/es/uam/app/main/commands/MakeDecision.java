...
public class MakeDecision extends MainCommand {
	...
	public void execute(Msg rm) throws SendMessageExc, Exception {
		...
		File png=SocioData.getSocioData().makeDecision(actual, d, p);
		throw new SendMessageExc( "The branch "+p.getCompleteName()+" is merged with the project "+p.getCompleteName(), png);
	}
