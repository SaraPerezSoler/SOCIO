...
public class ReceivedMessageXD implements Comparable<ReceivedMessageXD> {
	...
	public ReceivedMessageXD(String msg, User user, Date fecha, String command,String projectName, String id) {
		super();
		this.msg = msg;
		this.user = user;
		this.date = fecha;
	...
	@Override
	public int compareTo(ReceivedMessageXD o) {
