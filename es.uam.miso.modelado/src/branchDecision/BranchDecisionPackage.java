...
public interface BranchDecisionPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Preferences Round</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CONSENSUS__PREFERENCES_ROUND = DECISION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int PREFERENCE_ORDERING_FEATURE_COUNT = PREFERENCE_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link branchDecision.Consensus#getPreferencesRound <em>Preferences Round</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Preferences Round</em>'.
	 * @see branchDecision.Consensus#getPreferencesRound()
	 * @see #getConsensus()
	 * @generated
	 */
	EReference getConsensus_PreferencesRound();
	...
	/**
	 * Returns the meta object for the reference list '{@link branchDecision.Round#getUserPreferences <em>User Preferences</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Preferences Round</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CONSENSUS__PREFERENCES_ROUND = eINSTANCE.getConsensus_PreferencesRound();
