 ...
 * </p>
 * <ul>
 *   <li>{@link DslHistory.impl.UpdateImpl#getElement <em>Element</em>}</li>
 *   <li>{@link DslHistory.impl.UpdateImpl#getOld <em>Old</em>}</li>
 *   <li>{@link DslHistory.impl.UpdateImpl#getNew <em>New</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UpdateImpl extends ActionImpl implements Update {
		...
		if (element != null && element.eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DslHistoryPackage.UPDATE__ELEMENT, oldElement, element));
			}
		}
		return element;
	}
	...
	public void setElement(EObject newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DslHistoryPackage.UPDATE__ELEMENT, oldElement, element));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DslHistoryPackage.UPDATE__ELEMENT:
