 ...
 * @generated
 */
public class SocioProjectsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SocioProjectsPackage.SOCIO_APP: {
				SocioApp socioApp = (SocioApp)theEObject;
				T result = caseSocioApp(socioApp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SocioProjectsPackage.PROJECT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Socio App</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Socio App</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSocioApp(SocioApp object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Metamodel Project</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Metamodel Project</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
