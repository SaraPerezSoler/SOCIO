...
public class ProjectManagementDelUsers implements ConversationalState {
	...
	public static ProjectManagementDelUsers getState(Project project, int action) {
		return new ProjectManagementDelUsers(project, action);
	}

	private ProjectManagementDelUsers(Project project, int action) {
