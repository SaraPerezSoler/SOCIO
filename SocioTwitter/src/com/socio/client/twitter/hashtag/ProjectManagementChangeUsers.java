...
public class ProjectManagementChangeUsers implements ConversationalState {
	...
	public static ProjectManagementChangeUsers getState(Project project, int action) {
		return new ProjectManagementChangeUsers(project, action);
	}

	private ProjectManagementChangeUsers(Project project, int action) {
