...
public interface SocioProjectsPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int PROJECT__BRANCH_IS_LOCKING = 8;
	 ...
	 * @ordered
	 */
	int METAMODEL_PROJECT__BRANCHS = PROJECT__BRANCHS;
	...
	/**
	 * The meta object id for the '{@link socioProjects.impl.BranchGroupImpl <em>Branch Group</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see socioProjects.impl.BranchGroupImpl
	 * @see socioProjects.impl.SocioProjectsPackageImpl#getBranchGroup()
	 * @generated
	 */
	int BRANCH_GROUP = 6;
	 ...
	 * @ordered
	 */
	int BRANCH_GROUP_FEATURE_COUNT = 6;
	 ...
	 * @ordered
	 */
	int BRANCH_GROUP_OPERATION_COUNT = 0;
	...
	/**
	 * The meta object id for the '{@link socioProjects.GroupStatus <em>Group Status</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see socioProjects.GroupStatus
	 * @see socioProjects.impl.SocioProjectsPackageImpl#getGroupStatus()
	 * @generated
	 */
	int GROUP_STATUS = 9;
	...
	/**
	 * Returns the meta object for the reference '{@link socioProjects.Project#getBranchGroup <em>Branch Group</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getProject_BranchGroup();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link socioProjects.Project#getBranchs <em>Branchs</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link socioProjects.BranchGroup <em>Branch Group</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Branch Group</em>'.
	 * @see socioProjects.BranchGroup
	 * @generated
	 */
	EClass getBranchGroup();

	/**
	 * Returns the meta object for the attribute '{@link socioProjects.BranchGroup#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see socioProjects.BranchGroup#getName()
	 * @see #getBranchGroup()
	 * @generated
	 */
	EAttribute getBranchGroup_Name();

	/**
	 * Returns the meta object for the attribute '{@link socioProjects.BranchGroup#getCreateAt <em>Create At</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Create At</em>'.
	 * @see socioProjects.BranchGroup#getCreateAt()
	 * @see #getBranchGroup()
	 * @generated
	 */
	EAttribute getBranchGroup_CreateAt();

	/**
	 * Returns the meta object for the attribute '{@link socioProjects.BranchGroup#getStatus <em>Status</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Status</em>'.
	 * @see socioProjects.BranchGroup#getStatus()
	 * @see #getBranchGroup()
	 * @generated
	 */
	EAttribute getBranchGroup_Status();

	/**
	 * Returns the meta object for the container reference '{@link socioProjects.BranchGroup#getFather <em>Father</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getBranchGroup_Decision();

	/**
	 * Returns the meta object for the reference list '{@link socioProjects.BranchGroup#getBranchs <em>Branchs</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getBranchGroup_Branchs();
	...
	/**
	 * Returns the meta object for enum '{@link socioProjects.GroupStatus <em>Group Status</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for enum '<em>Group Status</em>'.
	 * @see socioProjects.GroupStatus
	 * @generated
	 */
	EEnum getGroupStatus();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference PROJECT__BRANCH_GROUP = eINSTANCE.getProject_BranchGroup();
		 ...
		 * @generated
		 */
		EReference PROJECT__BRANCHS = eINSTANCE.getProject_Branchs();
		...
		/**
		 * The meta object literal for the '{@link socioProjects.impl.BranchGroupImpl <em>Branch Group</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see socioProjects.impl.BranchGroupImpl
		 * @see socioProjects.impl.SocioProjectsPackageImpl#getBranchGroup()
		 ...
		 * @generated
		 */
		EAttribute BRANCH_GROUP__NAME = eINSTANCE.getBranchGroup_Name();
		 ...
		 * @generated
		 */
		EAttribute BRANCH_GROUP__CREATE_AT = eINSTANCE.getBranchGroup_CreateAt();
		 ...
		 * @generated
		 */
		EAttribute BRANCH_GROUP__STATUS = eINSTANCE.getBranchGroup_Status();
		 ...
		 * @generated
		 */
		EReference BRANCH_GROUP__DECISION = eINSTANCE.getBranchGroup_Decision();
		 ...
		 * @generated
		 */
		EReference BRANCH_GROUP__BRANCHS = eINSTANCE.getBranchGroup_Branchs();
		...
		/**
		 * The meta object literal for the '{@link socioProjects.GroupStatus <em>Group Status</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see socioProjects.GroupStatus
		 * @see socioProjects.impl.SocioProjectsPackageImpl#getGroupStatus()
		 * @generated
		 */
		EEnum GROUP_STATUS = eINSTANCE.getGroupStatus();
