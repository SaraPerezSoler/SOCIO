...
public class SocioProjectsAdapterFactory extends AdapterFactoryImpl {
	...
	protected SocioProjectsSwitch<Adapter> modelSwitch =
		new SocioProjectsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseModelProject(ModelProject object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link socioProjects.ModelProject <em>Model Project</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link socioProjects.BranchGroup <em>Branch Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
