...
/**
	...
	/*	private Map<String,Map<String, WeakReference<User>>> nick_user = new HashMap<>();
	private Map<String,Map<Long, WeakReference<User>>> id_user = new HashMap<>();
	
	
	public void initialize() {
		for (User u: users) {
			Map<String, WeakReference<User>> channelNickUsers = nick_user.get(u.getChannel());
			Map<String, WeakReference<User>> channelUsers = nick_user.get(u.getChannel());
		}
	}*/
