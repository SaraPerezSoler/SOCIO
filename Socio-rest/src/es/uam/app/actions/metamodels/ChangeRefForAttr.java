...
public class ChangeRefForAttr extends UpdateMetamodel implements IsAttribute{
	...
	public ChangeRefForAttr(MetamodelProject proj,ReferenceControl ref, int max) {
		super(proj);
		this.remove = new RemoveReference (proj, ref);
		this.createAttribute = new CreateAttribute(proj,ref.getName(), ref.getParent(), ref.getMin(), max);
	}
	...
	@Override
	public int getMin() {
		return createAttribute.getMin();
	}

	@Override
	public int getMax() {
		return createAttribute.getMax();
	}
