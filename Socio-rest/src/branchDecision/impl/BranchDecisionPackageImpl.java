...
public class BranchDecisionPackageImpl extends EPackageImpl implements BranchDecisionPackage {
	...
	public void createPackageContents() {
		...
		createEReference(consensusEClass, CONSENSUS__ROUNDS);
		...
		createEAttribute(roundEClass, ROUND__ROUND_DATE);
		...
		createEReference(preferenceOrderingEClass, PREFERENCE_ORDERING__ORDER);
	...
	public void initializePackageContents() {
		...
		initEReference(getConsensus_Rounds(), this.getRound(), null, "rounds", null, 1, -1, Consensus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRound_RoundDate(), ecorePackage.getEDate(), "roundDate", null, 1, 1, Round.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPreferenceOrdering_Order(), this.getOrder(), null, "order", null, 1, -1, PreferenceOrdering.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
