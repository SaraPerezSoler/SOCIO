 ...
 * @generated
 */
public class RecommenderQuestionnaireSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public RecommenderQuestionnaireSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RecommenderQuestionnairePackage.TOOL: {
				...
				if (result == null) result = caseWithName(tool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RecommenderQuestionnairePackage.QUESTION: {
				...
				if (result == null) result = caseWithName(question);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RecommenderQuestionnairePackage.EVALUATION: {
				...
				if (result == null) result = caseQuestion(evaluation);
				if (result == null) result = caseWithName(evaluation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RecommenderQuestionnairePackage.ANSWER: {
			...
			case RecommenderQuestionnairePackage.WITH_NAME: {
				WithName withName = (WithName)theEObject;
				T result = caseWithName(withName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>With Name</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>With Name</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWithName(WithName object) {
		return null;
	}
...
} //RecommenderQuestionnaireSwitch
