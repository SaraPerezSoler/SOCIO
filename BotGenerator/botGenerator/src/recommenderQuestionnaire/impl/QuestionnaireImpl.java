 ...
 * </p>
 * <ul>
 * <li>{@link recommenderQuestionnaire.impl.QuestionnaireImpl#getTools
 * <em>Tools</em>}</li>
 * <li>{@link recommenderQuestionnaire.impl.QuestionnaireImpl#getQuestions
 * <em>Questions</em>}</li>
 * </ul>
 *
 * @generated
...
public class QuestionnaireImpl extends MinimalEObjectImpl.Container implements Questionnaire {
	...
	/**
	 * The cached value of the '{@link #getQuestions() <em>Questions</em>}'
	...
	public EList<Tool> getTools() {
		if (tools == null) {
			tools = new EObjectContainmentEList<Tool>(Tool.class, this,
					RecommenderQuestionnairePackage.QUESTIONNAIRE__TOOLS);
		}
		return tools;
	}
	...
	public EList<Question> getQuestions() {
		if (questions == null) {
			questions = new EObjectContainmentEList<Question>(Question.class, this,
					RecommenderQuestionnairePackage.QUESTIONNAIRE__QUESTIONS);
		}
		return questions;
	}
