...
public class ProjectManagerChangeVisibility implements ConversationalState{

	private Project project;

	public static ProjectManagerChangeVisibility getState(Project project) {
		return new ProjectManagerChangeVisibility(project);
	}

	private ProjectManagerChangeVisibility(Project project) {
